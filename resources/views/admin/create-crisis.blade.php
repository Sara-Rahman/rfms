...
<form action=" {{route('crisis.store')}} " method="POST">
  ...
  <div class="container">
    ...
    <label for="email"><b>Crisis Type</b></label>
    <input type="text" placeholder="Enter Crsis Type" name="email" id="email" required>

    <label for="psw"><b>Amount</b></label>
    <input type="text" placeholder="Enter Amount" name="psw" id="psw" required>
